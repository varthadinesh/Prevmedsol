                                    ...
                                    db.query(createPhysicalExam2Query, (err) => {
                                        ...
                                        db.query(createAssementTableQuery, (err) => {
                                            ...
                                            db.query(createReviewSystem2Query, (err) => {
                                                ...
                                                db.query(createReviewSystem3Query, (err) => {
                                                    if (err) throw err;
                                              
                                                db.query(createHistory1TableQuery, (err) => {
                                                    if (err) throw err;
                                              
                                                   
                                                db.query(createHistory2TableQuery, (err) => {
                                                    if (err) throw err;
                                              
                                                    db.query(createMedicationsTableQuery, (err) => {
                                                        if (err) throw err;
                                                  
                                                        db.query(createReviewSystem1TableQuery, (err) => {
                                                            if (err) throw err;
...
app.post('/history1', (req, res) => {
    const sql = 'insert into emrhistory1 (`history1_id`, `complaint_date`, `present_illness`, `onset`, `duration`, `frequency`, `location`, `quality`, `severity`, `aggravating_factors`, `alleviating_factors`, `associated_symptoms`) values (?)';
...
app.post('/medication', (req, res) => {
    const sql = 'insert into emrmedication (`medications_id`, `medications`, `medicine_type`, `medicine_name`, `dose`, `frequency`, `duration`, `reason_for_taking`, `compliance`, `takes_as_prescribed`, `allergies`, `allergic_reaction`, `allergy_type`) values (?)';
...
app.post('/addassessment', (req, res) => {
    const sql = "INSERT INTO assessments (`assement_id`,`assessment`, `plans`) VALUES (?)";
