                          ...
                          if (item.date > date) {
                            return (
                              <tr key={index}>
                                ...
                                <td>{item.center}</td>
                                <td><Link to="/booknewappointment" className="text-decoration-none"><i class="bi bi-clock"></i> Re-Schedule</Link></td>
                                <td><button onClick={cancelClick} className="btn"><i class="bi bi-x-lg text-danger"></i> Cancel</button></td>
                              </tr>
                            );
                          }
                        }
                          ...
                          if (item.date < date) {
                            return (
                              <tr key={index}>
                                ...
                                <td>{item.appointment}</td>
                                <td>{item.center}</td>
                                <td><button className="btn" data-bs-toggle="modal" data-bs-target="#myModal"><i class="bi bi-folder2-open"></i> Reports</button></td>
                                <td><i class="bi bi-eye-fill"></i> After Visit Doc</td>
                              </tr>
                            );
                          }
                        }
