      ...
      <div className="d-flex ">
        ...
        <div className="col-10 p-0">
          <nav className="d-flex bg-light border border-bottom-info p-2">
            ...
            &gt; <Link to="/managepackage" className="text-decoration-none">Packages</Link> &gt; Add Package
          </nav>
          ...
          <div className="">
            <div className="col-xs-12">
              ...
              >
                ...
                <div className="form-group d-md-flex">
                  <label className="col-sm-4 text-md-end text-primary" htmlFor="description">
                    {" "}
                    Description{" "}
                  </label>
                  <div className="col-sm-8">
                ...
                <div className="form-group d-md-flex">
                  <label className="col-sm-4 text-md-end text-primary" htmlFor="amount">
                    {" "}
                    Price
                  </label>
                  <div className="col-sm-8">
                ...
                <div className="form-group d-md-flex">
                  <label className="col-sm-4 text-md-end text-primary" htmlFor="imageurl">
                    {" "}
                    Image URL{" "}
                  </label>
                  <div className="col-sm-8">
