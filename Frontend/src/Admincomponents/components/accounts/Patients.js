        ...
        <div className="ps-2 pe-2 ps-lg-4 pe-lg-4 pb-4">
              ...
              >
                <div className="p-2 d-flex">
                  <label className="mt-2" htmlFor="rowsDropdown" style={{ minWidth: "120px" }}>
                    Display records
                  </label>
                  <select
              ...
              <Pagination stateData={patients} pageSize={pageSize} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
              {/* <div
                className="d-flex justify-content-between "
                style={{ background: "#EFF3F8", width: "100%" }}
              >
