...
const Labagents = () => {
  ...
  // const totalPages = Math.ceil(labagents.length / pageSize);
    ...
    (<div className="d-flex ">
      ...
      <div className="col-sm-12 col-md-12 col-lg-10 p-0">
        ...
        <div className="ps-2 pe-2 ps-lg-4 pe-lg-4 pb-4">
          ...
          <Pagination stateData={labagents} pageSize={pageSize} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
        </div>
        <hr></hr>
