    ...
    <>
      ...
      <div className="d-flex ">
        ...
        <div className="col-sm-12 col-md-12 col-lg-10 p-0">
          ...
          <Link to="/patientupcomingappointment"><button className="btn btn-success text-white ms-4 m-1">Upcoming</button></Link>
          <Link to="/patientpreviousappointment"><button className="btn btn-dark text-white">Previous</button></Link>
          <div className="">
