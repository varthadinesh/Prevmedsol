              ...
              <Tabs defaultActiveKey="first" className="bg-light">
                  ...
                  <div className="ps-2 pe-2 ps-lg-4 pe-lg-4 pb-4 mt-4">
                    ...
                    >
                      <div className="p-2 d-flex">
                        <label className="mt-2" htmlFor="maxpages2" style={{ minWidth: "120px" }}>
                          Display records
                        </label>
                        <select
                      ...
                      <div className="p-2 d-flex">
                        <label className="mt-2" htmlFor="searchbox2">Search:</label>
                        <input
                          type="search"
                          placeholder=""
                          aria-controls="dynamic-table"
                        ...
                        <tr role="row">
                          ...
                          >
                            <label className="pos-rel">
                              <input type="checkbox" name="allcheckboxes2" className="ace" />
                ...
                <Tab eventKey="second" title="Previous">
                  <div className="ps-2 pe-2 ps-lg-4 pe-lg-4 pb-4 mt-4">
                    ...
                    >
                      <div className="p-2 d-flex">
                        <label className="mt-2" htmlFor="maxpages" style={{ minWidth: "120px" }}>
                          Display records
                        </label>
                        <select
                          name="dynamic-table_length"
                      ...
                      <div className="p-2 d-flex">
                        <label className="mt-2" htmlFor="searchbox">Search:</label>
                        <input
                          type="search"
                          placeholder=""
                          aria-controls="dynamic-table"
                    ...
                    >
                      <thead>
                        <tr role="row">
                          ...
                          >
                            <label className="pos-rel">
                              <input type="checkbox" name="allcheckbox" className="ace" />
                              <span className="lbl"></span>
                            </label>
                          </th>
                          <th
