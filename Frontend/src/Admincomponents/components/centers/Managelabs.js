...
const Managelabs = () => {
  ...
  const handleSave = (e) => {
    e.preventDefault();
    axios
      .post(`http://localhost:8080/managelabs`, editedData)
      .then((res) => {
        console.log(res);
      ...
      {isEditing ? (
        ...
        <div className="d-flex ">
          ...
          <Csvclipboard/>
              ...
              >
                <Link to="/addlab" className="text-decoration-none text-white">
          ...
          <Searchbar pageSize={pageSize} setPageSize={setPageSize}/>
              ...
              <Pagination stateData={labs} pageSize={pageSize} setViewRowIndex={setViewRowIndex} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
