    ...
    <>
      ...
      <div className="d-flex">
        ...
        <div className="col-10 p-0">
          ...
          <Link to="/labagentappointments"><button className="btn btn-dark text-white ms-4 m-1">Upcoming</button></Link>
          <Link to="/labagentpreviousappointments"><button className="btn btn-success text-white">Previous</button></Link>
