        ...
        <div className="col-10 historybg">
          <div id="history_1" class="history_1">
            <div class="history_area">
                      ...
                      <div className="accordion-body p-4">
                        <div className="col-xs-12">
                          <div className="form-group row">
                            <label className="col-xs-12">Medications</label>
                            <div className="col-xs-12">
                              <textarea
                                name="medications"
                                id="medications"
                      ...
                      <div className="accordion-body p-4">
                        <div className="row">
                          <div className="col-xs-12 col-sm-6">
                            <div className="form-group row">
                              <label className="col-xs-12">Type</label>
                              <div className="col-xs-12">
                                <select
                                  name="medicine_type"
                                  id="medicine_type"
                          ...
                          <div className="col-xs-12 col-sm-6">
                            <div className="form-group row">
                              <label className="col-xs-12">Dose</label>
                              <div className="col-xs-12">
                                <input
                                  type="text"
                                  name="dose"
                          ...
                          <div className="col-xs-12 col-sm-6">
                            <div className="form-group row">
                              <label className="col-xs-12">Frequency</label>
                              <div className="col-xs-12">
                                <input
                                  type="text"
                                  name="frequency"
                          ...
                          <div className="col-xs-12 col-sm-6">
                            <div className="form-group row ">
                              <label className="col-xs-12">Duration</label>
                              <div className="col-xs-12">
                                <input
                                  type="text"
                                  name="duration"
              ...
              <button className="btn btn-success m-2 mb-5 ms-2 p-2 ps-4 pe-4">
                Save
              </button>
            </div>
          </div>
