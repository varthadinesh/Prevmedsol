                    ...
                    <div className="accordion-body">
                      <div className="col-xs-12">
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_weight_change_yes">
                            Weight Change
                          </label>
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_weight_change_in_kg">
                            Weight change in KG
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <input
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_when">
                            When ?
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <input
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_fatigue_yes">
                            Fatigue
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_weakness_yes">
                            Weakness
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_fever_yes">
                            Fever
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_chills_yes">
                            Chills
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_night_sweats_yes">
                            Night sweat
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
                ...
                >
                  ...
                  >
                    <div className="accordion-body">
                      <div className="col-xs-12">
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_trauma_yes">
                            Trauma
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
                        ...
                        <div className="row form-group">
                          <label className="col-xs-5 col-sm-3 col-md-2" htmlFor="rs1_headache_yes">
                            Headache
                          </label>
                          <div className="col-xs-7 col-sm-5 col-md-6">
                            <label className="radio-inline">
