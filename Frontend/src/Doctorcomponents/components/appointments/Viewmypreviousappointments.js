    ...
    <>
      ...
      <div className="d-flex">
        ...
        <div className="col-10 p-0">
          ...
          <Link to="/doctorappointments"><button className="btn btn-dark text-white ms-4 m-1">Upcoming</button></Link>
          <Link to="/doctorpreviousappointments"><button className="btn btn-success text-white">Previous</button></Link>
