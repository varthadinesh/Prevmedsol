          ...
          {location.pathname !== "/dashboardPage" &&
            ...
            location.pathname !== "/viewpayments" && (
              ...
              >
                ...
                <button className="btn text-white"  data-bs-toggle="modal" data-bs-target="#myModal">Cart {cartItems.length}</button>
              </div>
            )}
          {location.pathname !== "/" &&
          ...
          <div className="modal-dialog modal-md">
            ...
            <div
              ...
              <div
                ...
                <button type="button" className="btn btn-success m-2" data-bs-dismiss="modal">Buy</button>
                <button type="button" className="btn btn-danger" data-bs-dismiss="modal" onClick={() => removeFromCart(item.id)}>Delete</button>
