          ...
          >
            ...
            <tbody>
              <tr role="row" className="odd">
                ...
                <td>kaviraaj thakur</td>

                <td>admin@admin</td>

                <td className="hidden-480">6666666666</td>
                <td className="hidden-480">toprani</td>
              ...
              <tr role="row" className="even">
                ...
                <td>raaju choudhari</td>

                <td>admin@admin</td>

                <td className="hidden-480">7123456898</td>
                <td className="hidden-480">toprani</td>
                <td>active</td>
